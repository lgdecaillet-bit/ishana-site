(function(){
  ...
  function startTyped(overridePhrases){
    ...
    const typeSpeed  = +(el.dataset.typeSpeed  || 52);
    const eraseSpeed = +(el.dataset.eraseSpeed || 34);
    const hold       = +(el.dataset.hold       || 1650);
    ...
    (function tick(){
      ...
      if(dir===0 && pos===0){ i=(i+1)%phrases.length; dir=1; setTimeout(tick,380); }
    })();
  }
